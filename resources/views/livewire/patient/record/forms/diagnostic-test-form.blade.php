...
state(['patient', 'record' => null, 'test_name' => '', 'results' => '', 'test_date' => '', 'notes' => '', 'isSubmitting' => false]);
...
$save = function () {
    ...
    try {
        ...
        $this->dispatch('diagnostic-tests-refreshed');
        $this->dispatch('close-modal');
    } catch (\Exception $e) {
        $this->addError('save', 'Failed to save diagnostic test record.');
    } finally {
