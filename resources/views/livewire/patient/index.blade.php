...
<div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="space-y-6">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Patient Management</h1>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Manage patient records and medical information</p>
                    </div>
                    <div class="flex space-x-3">
                        <form wire:submit="import" class="flex items-center">
                            ...
                            <button type="button" onclick="document.getElementById('csvImport').click();"
                            ...
                            <button x-show="$wire.importFile !== null" class="ml-2 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500" type="submit">
                                {{ __('Upload') }}
                            </button>
                        </form>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input wire:model.live.debounce.300ms="search" type="text" placeholder="Search by patient name or phone number..."
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-600 dark:text-gray-400">
                            Showing {{ $patients->count() }} of {{ $patients->total() }} {{ Str::plural('patient', $patients->total()) }}
                        </div>
                    </div>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse ($patients as $patientDoctor)
                                    <tr class="group hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer" wire:click="detail({{ $patientDoctor->patient_id }})">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200">
                                                {{ ucfirst($patientDoctor->patient->gender) }}
                                            </span>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                                <!-- View Details Icon -->
                                                <button wire:click.stop="detail({{ $patientDoctor->patient_id }})"
                                                ...
                                                <button wire:click.stop="delete({{ $patientDoctor->patient_id }})"
                                                        ...
                                                        class="p-1.5 rounded-full hover:bg-red-100 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-colors duration-200"
    ...
    <x-modal name="form-patient" :show="$errors->isNotEmpty()" focusable>
            <div class="relative">
                ...
                <fieldset class="border-2 border-double border-gray-200 dark:border-gray-600 p-4 rounded-md">
                    <legend class="text-gray-400 dark:text-gray-500 px-2">{{ __('Personal Details') }}</legend>
                ...
                <fieldset class="border-2 border-double border-gray-200 dark:border-gray-600 p-4 rounded-md mt-6">
                    <legend class="text-gray-400 dark:text-gray-500 px-2">{{ __('Emergency Contact') }}</legend>
                    <div class="flex justify-between gap-4">
                        <div class="w-1/2">
