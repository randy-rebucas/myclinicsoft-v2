...
$save = function () {
    try {
        ...
        $this->dispatch('refresh');
        $this->dispatch('med-representative-saved');
        $this->notification = ['type' => 'success', 'message' => 'Med Representative details updated successfully'];
    } catch (\Exception $e) {
        $this->notification = ['type' => 'error', 'message' => 'Failed to update med representative details'];
    }
};
?>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
            ...
            <div class="flex justify-between items-center mb-4">
                <div class="relative">
                    ...
                    <x-text-input wire:model.live="search" class="ps-12 w-full py-2.5 bg-white" type="search"
                        :placeholder="__('Search representatives...')" />
                </div>
                            ...
                            <div class="p-4" wire:click="detail({{ $item->medRepresentative }})">
                                ...
                                <div class="mt-2 space-y-1">
                                    ...
                                    <p class="text-sm text-gray-600 flex items-center gap-2">
                                        ...
                                        {{ $item->medRepresentative->user->email }}
                                    </p>
                                </div>
                            </div>
