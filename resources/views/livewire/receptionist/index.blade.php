...
$detail = function (Receptionist $receptionist) {
    return false;
    // return redirect()->route('receptionist-detail', ['receptionistId' => $receptionist]);
                ...
                @forelse ($receptionists as $receptionist)
                    <div class="cursor-pointer bg-white rounded-lg shadow-sm border border-gray-100 p-4 hover:shadow-md transition-all duration-200 group relative"
                        ...
                        <div class="flex justify-between items-start">
                            <div class="p-4" wire:click="detail({{ $receptionist }})">
                            ...
                            <div
                                ...
                                <button wire:click.stop="edit({{ $receptionist->id }})"
                                ...
                                <button wire:click.stop="delete({{ $receptionist }})"
