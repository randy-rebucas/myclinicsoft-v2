...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('med_representatives', function (Blueprint $table) {
            $table->id();
            $table->string('first_name');
            $table->string('last_name');
            $table->string('phone_number')->nullable();
        ...
        Schema::create('immunizations', function (Blueprint $table) {
            ...
            $table->string('administrator')->nullable()->comment("e.g., Physician, Nurse");
            $table->text('notes')->nullable();
            $table->foreignId('patient_id')->constrained()->cascadeOnUpdate()->cascadeOnDelete();
            $table->timestamps();
            ...
            $table->index('patient_id');
            $table->index(['patient_id', 'date_administered']);
        });
        ...
        Schema::create('med_rep_doctors', function (Blueprint $table) {
            ...
            // Indexes for performance
            $table->index('med_representative_id');
            $table->index('doctor_id');
            $table->index('is_active');
            $table->index(['med_representative_id', 'is_active']);
            $table->index(['doctor_id', 'is_active']);
        });

        // Essential missing tables for clinic operations
        ...
        Schema::create('billing_invoices', function (Blueprint $table) {
            ...
            // Note: Check constraints removed for compatibility
        ...
        Schema::create('invoice_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('invoice_id')->constrained('billing_invoices')->cascadeOnUpdate()->cascadeOnDelete();
    ...
    {
        // Drop new essential tables first
        Schema::dropIfExists('audit_logs');
        Schema::dropIfExists('notifications');
        Schema::dropIfExists('prescriptions');
        Schema::dropIfExists('lab_results');
